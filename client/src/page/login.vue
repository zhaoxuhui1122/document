<template>
    <div class="login-container">
        <h2 class="project-name">文档管理平台</h2>
        <div class="login-form">
            <ul>
                ...
                <li class="input">
                    <input :class="{error:passwordError}" v-model="password" @blur="validatePassword" type="password" name="password" id="password" placeholder="请输入密码" autocomplete="off">
                </li>
                <li :class="`error ${passwordError?'active':''}`">请输入密码</li>
    ...
    export default {
        ...
        methods: {
            ...
            async handleSubmit() {
                ...
                if (name && password) {
                    const res = await this.$post(this.$API.userLogin, {
                        name,
                        password
                    });
                    if (res.resultCode) {
